  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="relative z-20 space-y-20">
        {/* Hero Section */}
        <section className="text-center py-20 rounded-md shadow-md overflow-hidden">
          {/* Content */}
          <div className="relative z-20">
            <h1 className="text-4xl sm:text-5xl font-extrabold tracking-tight text-blue-800 mb-4">
              Welcome to MyShop
            </h1>
            <p className="text-blue-600 text-lg max-w-xl mx-auto mb-8">
        ...
        <section id="products" className="max-w-6xl mx-auto px-4">
          <h2 className="text-2xl text-blue-600 font-semibold mb-6">Featured Products</h2>
          <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            ...
            {products.map((product) => (
              <div
                ...
                className="border rounded-lg p-4 shadow-sm hover:shadow-md transition flex flex-col bg-black/60 rounded-lg p-4"
              >
                <img
                ...
                <button
                  ...
                  className="mt-auto px-4 py-2 bg-blue-600 text-white text-sm font-medium border-1 border-black rounded hover:bg-blue-700 transition"
                >
                  Add to Cart
                </button>
              </div>
